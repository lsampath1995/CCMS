...
<?php $__env->startSection('header'); ?>
    <form action="<?php echo e(route('backupmanager_create')); ?>" method="post" id="frmNew">
        ...
        <button type="submit" class="btn btn-warning btn-sm"><a href="<?php echo e(url('http://localhost/')); ?>"><i class="fa fa-caret-left"></i> Back</a></button>
    </form>
            ...
            <?php $__currentLoopData = $backups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $backup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td style="text-align: center;">
                        <span class="col-sm-8 badge badge-<?php echo e($backup['type'] === 'Files' ? 'primary' : 'success'); ?>"><?php echo e($backup['type']); ?></span>
                    </td>
                    <td style="text-align: center;">
