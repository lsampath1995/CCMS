    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu" role="menu">
            <?php if (isset($view_modal)): ?>
                <li><a data-target-modal="<?php echo e($view_modal->get('target')); ?>"
                       ...
                       href="<?php echo e($view_modal->get('action', 'javaqscrip:void(0)')); ?>"><i
            ...
            <?php endif; ?>
            <?php if (isset($view)): ?>
                <li><a href="<?php echo e($view ?? 'javascrip:void(0)'); ?>"><i
                            class="fa fa-eye"></i>&nbsp;&nbsp;View</a></li>
            <?php endif; ?>
            <?php if (isset($edit)): ?>
                <li class="<?php echo e(isset($edit_permission) && $edit_permission == "1" ? '' : 'hidden'); ?>"><a
                        href="<?php echo e($edit ?? 'javascrip:void(0)'); ?>"><i class="fa fa-edit"></i>&nbsp;&nbsp;Edit</a>
                </li>
            <?php endif; ?>
            ...
            <?php if (isset($print)): ?>
                <li class="divider"></li>
                <li><a target="_blank" href="<?php echo e($print); ?>"><i class="fa fa-print"></i>&nbsp;&nbsp;Print</a>
                </li>
            <?php endif; ?>
            <?php if (isset($email)): ?>
            ...
            <?php if (isset($payment_recevie_modal)): ?>
                <li class="<?php echo e(isset($edit_permission) && $edit_permission == "1" ? '' : 'hidden'); ?>">
                    <a class="call-model "
                       data-url="<?php echo e($payment_recevie_modal->get('action', 'javaqscrip:void(0)')); ?>"
                       data-id=<?php echo e($payment_recevie_modal->get('id')); ?>

                       href="<?php echo e($payment_recevie_modal->get('action', 'javaqscrip:void(0)')); ?>"
                       data-target-modal="<?php echo e($payment_recevie_modal->get('target')); ?>"><i
                            class="fa fa-money"></i>&nbsp;&nbsp;
            ...
            <?php if (isset($payment_histroy_modal)): ?>
                <li>
                    <a class="call-model"
                       data-url="<?php echo e($payment_histroy_modal->get('action', 'javaqscrip:void(0)')); ?>"
                       data-id=<?php echo e($payment_histroy_modal->get('id')); ?>

                       href="<?php echo e($payment_histroy_modal->get('action', 'javaqscrip:void(0)')); ?>"
                       data-target-modal="<?php echo e($payment_histroy_modal->get('target')); ?>"><i
            ...
            <?php if (isset($next_date)): ?>
                ...
                <li class="<?php echo e(isset($edit_permission) && $edit_permission == "1" ? '' : 'hidden'); ?>">
                    <a class="call-model" data-url="<?php echo e($next_date->get('action', 'javaqscrip:void(0)')); ?>"
                       ...
                       data-target-modal="<?php echo e($next_date->get('target')); ?>"><i
            ...
            <?php if (isset($next_date_case)): ?>
                ...
                <li>
                    ...
                    ?>
                    <a class="call-model"
                       onClick='nextDateAdd(<?php echo e($next); ?>);'><i class="fa fa-calendar-plus-o"></i>&nbsp;&nbsp;
                        Next Date</a>
                </li>
            <?php endif; ?>
            <?php if (isset($case_transfer)): ?>
                ...
                <li class="<?php echo e(isset($edit_permission) && $edit_permission == "1" ? '' : 'hidden'); ?>">
                    ...
                    ?>
                    <a class="call-model"
                       onClick='transfer_case(<?php echo e($transfer_case); ?>);'><i class="fa fa-gavel"></i>&nbsp;&nbsp;
                        Case
                        Transfer</a></li>
            <?php endif; ?>
            <li>
        ...
        <?php endif; ?>
            <?php if (isset($payment_made)): ?>
                ...
                <li class="<?php echo e(isset($edit_permission) && $edit_permission == "1" ? '' : 'hidden'); ?>">
                    <a class="call-model"
                       data-url="<?php echo e($payment_made->get('action', 'javaqscrip:void(0)')); ?>"
            ...
            <?php if (isset($payment_made_history)): ?>
                <li>
                    <a class="call-model"
                       ...
                       data-target-modal="<?php echo e($payment_made_history->get('target')); ?>"><i
                            class="fa fa-history"></i>&nbsp;&nbsp;
