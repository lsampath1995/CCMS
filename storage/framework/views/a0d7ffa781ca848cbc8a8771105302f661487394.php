    ...
    <div class="login_wrapper">
        <div class="animate form login_form">
            <section class="login_content">
                ...
                <?php endif; ?>
                <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/admin/password/email')); ?>">
                    <?php echo e(csrf_field()); ?>

                    <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('public/upload/logo/logo.png')); ?>"
