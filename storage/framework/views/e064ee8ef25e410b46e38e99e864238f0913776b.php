...
<?php if ($adminHasPermition->can(['dashboard_list'])): ?>
    <br><br><br><br>
    <link href="<?php echo e(asset('assets/admin/vendors/fullcalendar/dist/fullcalendar.min.css')); ?> "
          rel="stylesheet">
                    ...
                    <div class="x_content">
                        <?php if ($totalCaseCount > 0): ?>
                            <?php if (count($case_dashbord) > 0 && !empty($case_dashbord)): ?>
                                <?php $__currentLoopData = $case_dashbord;
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $court): $__env->incrementLoopIndices();
                                    ...
                                    <table id="case_list" class="table row-border" style="width:100%">
                                        ...
                                        <?php if (!empty($court['cases']) && count($court['cases']) > 0): ?>
                                            <?php $__currentLoopData = $court['cases'];
                                            $__env->addLoop($__currentLoopData);
