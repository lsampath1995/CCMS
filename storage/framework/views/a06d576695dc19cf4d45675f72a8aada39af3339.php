...
<a href="<?php echo e(url('http://localhost/')); ?>"><img alt="logo" class="center"
                                                          src="<?php echo e(asset('public/upload/logo/logo.png')); ?>"></a><br><br><br><br>
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <?php if (Session::has('messages')): ?>
                <?php $__currentLoopData = Session::get('messages');
                $__env->addLoop($__currentLoopData);
                foreach ($__currentLoopData as $message): $__env->incrementLoopIndices();
                    $loop = $__env->getLastLoop(); ?>
                    <p class="alert alert-<?php echo e($message['type']); ?>">
...
<?php /**PATH E:\Xampp\htdocs\vendor\sarfraznawaz2005\backupmanager\src/Views/layout/layout.blade.php ENDPATH**/ ?>
