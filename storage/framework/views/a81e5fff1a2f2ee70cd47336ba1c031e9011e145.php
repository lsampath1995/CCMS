    ...
    <div class="menu_section">
        <ul class="nav side-menu">
            <?php if($adminHasPermition->can(['dashboard_list'])=="1"): ?>
                <li><a href="<?php echo e(url('admin/dashboard')); ?>"><i class="fa fa-tachometer"></i> Dashboard</a></li>
            <?php endif; ?>
            ...
            <?php if($adminHasPermition->can(['case_list']) =="1"): ?>
                <li><a href="<?php echo e(route('case-running.index')); ?>"><i class="fa fa-gavel"></i> Court Cases</a></li>
            <?php endif; ?>
            ...
            <?php if($adminHasPermition->can(['appointment_list']) =="1"): ?>
                <li><a href="<?php echo e(route('appointment.index')); ?>"><i class="fa fa-calendar-plus-o"></i> Appointments</a>
                </li>
            <?php endif; ?>
            ...
            || $adminHasPermition->can(['general_setting_edit'])=="1"): ?>
                <li><a><i class="fa fa-gear"></i>System Settings <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        ...
                        <?php endif; ?>
                        <?php if(\Auth::guard('admin')->user()->user_type=="Admin"): ?>
                            <li><a href="<?php echo e(url('http://localhost/backupmanager')); ?>">Database & File Backups</a></li>
                        <?php endif; ?>
                    </ul>
                </li>
            <?php endif; ?>
