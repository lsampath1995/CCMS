...
class CaseRunningController extends Controller
{
    ...
    public function allCaseList(Request $request)
    {
        ...
        foreach ($customcollections as $key => $case) {
            ...
            $row['name'] = '<div style="font-size:13px;"  class="clinthead text-primary">' . $priorityModal . ''
                . '&nbsp;<a class="title text-primary"  href="' . $case_list . '">' . $case->first_name . '&nbsp;' . $case->middle_name . '&nbsp;' . $case->last_name . '</a></div><br>
            ...
            $row['case'] = '<p class="currenttittle">' . $first . ' <br/><b>&</b> <br/>' . $second . '<p>';
