            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td width="25%">
                        @if($setting->logo_img !='')
                            <img
                                src="{{ asset('public/' . config('constants.LOGO_FOLDER_PATH') . '/' . $setting->logo_img)}}">
                        @else
                            <img src="{{ asset('public/upload/logo.png') }}">
                        @endif
                    </td>
                    <td width="75%" valign="top">
                        <h1 class="heading1" style="text-align: center;"><b>{{ $invoice_no ?? ''}} - Invoice</b></h1>
...
<table border="1" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <td width="36%" valign="top">
                        <table width="100%" border="0" cellpadding="4" cellspacing="0"
                            ...
                            <tr>
                                ...
                                <td width="50%" style="color: #953b39">: {{ $invoice_no ?? ''}}</td>
                            </tr>
                            <tr>
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td width="25%" align="center"
                        style="border-right: 1px solid #000;border-bottom: 1px solid #000;font-size: 9pt;"><strong>Service
                            Name</strong>
                    </td>
    ...
    <tr>
        <td><br>
            <table border="0" cellpadding="5" cellspacing="0" width="100%">
                <tr>
                    <td width="72%" valign="top" align="center"><strong>Total Amount In Words
                            : {{ ucfirst($total_amount_world) }} </strong>
                    </td>
    ...
    <tr align="center">
        <td align="center">
            <table align="center"><img align="middle" src="{{ asset('public/upload/barcode.png') }}"></table>
        </td>
    </tr>
    <tr>
        <td>
                ...
                <tr>
                    ...
                    <td style="border-left: 1px solid #000;" valign="top" width="33%">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td>
                                    <strong style="font-size:13px;">Remarks :</strong> <br><br/>
                                    {{$invoice->remarks}}
                                </td>
                            </tr>
                        </table>
...
<br>
<p align="center" style="font-size: smaller">© cms software inc. </p>
</body>
</html>
