        ...
        <form action="{{route('judge.update',$judge->id)}}" method="POST" id="tagForm" name="tagForm">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2"><i class="fa fa-user"></i>&nbsp;&nbsp;Edit Judge</h4>
                </div>
                <div class="modal-body">
                    <div id="form-errors"></div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="case_subtype">Judge Name <span class="text-danger">*</span></label>
                            <input type="text" placeholder="enter judge name" class="form-control" id="judge_name"
                                   name="judge_name"
