        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="form-group pull-right top_search">
                    <a href="{{ url('admin/invoice') }}" class="btn btn-primary"><i class="fa fa-backward"></i>
                        &nbsp;&nbsp;Back</a>
                </div>
            </div>
        </div>
                ...
                <section class="content invoice">
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                <div class="col-md-12 form-group ">
                                    <label for="vendor">Client Name <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <table class="table tableInv" id="purchaseInvoice" data-repeater-list="invoice_items">
                                    ...
                                    <tr class="tbl_header_color dynamicRows">
                                        ...
                                        <th class="hide with_tax" width="10%" class="text-center">Tax (LKR)</th>
                                    ...
                                    <tr data-repeater-item>
                                        <th width="30%" class="text-center">
                                            <select class="form-control sel services" name="services" id="services"
                                                ...
                                                <option MyServiceAmount="0.00" value="">select service</option>
                            ...
                            <br>
                            <button data-repeater-create value="Add New"
                            ...
                            <div class="row">
                                <div class="col-sm-7 col-md-7">
                                    <div class="contct-info">
                                        <div class="form-group"><br>
                                            <label class="discount_text"> Invoice Note
                                            </label>
                                            <textarea placeholder="add invoice note" class="form-control" id="note"
                                ...
                                <div class="pull-right col-md-5">
                                    ...
                                    <table class="table row-border dataTable no-footer" id="tab_logic_total">
                                        <tr>
                                            <th class="text-left expence-p-top-18">Total Amount :</th>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 text-center">
                                    <a href="{{ url('admin/invoice') }}" class="btn btn-danger"><i
                                            class="fa fa-times"></i>
                                        &nbsp;&nbsp;Cancel</a>
