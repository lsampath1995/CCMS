            ...
            <form method="post" class="" id="form_payment" name="form_payment">
                ...
                <div class="modal-body">
                            ...
                            <div class="contct-info">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="enter received amount"
                                           id="amount" name="amount" class="form-control" value=""
                                           autocomplete="off">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="contct-info">
                                <div class="form-group"><br>
                                    <label class="discount_text">Received Date
                                        <er class="rest">*</er>
                                    </label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="contct-info">
                                <div class="form-group"><br>
                                    <label class="discount_text">Received Payment Method
                                        <er class="rest">*</er>
                                    </label>
                        ...
                        <div class="col-md-12">
                            <div class="contct-info">
                                <div class="form-group"><br>
                                    ...
                                    <textarea id="note" name="note" placeholder="add note"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="judge_type_btn" class="btn btn-success"><i
                            class="fa fa-spinner fa-spin hide" id="btn_loader"></i><i class="fa fa-save"></i>
                        &nbsp;&nbsp;Save
                    </button>
                </div>
            </form>
