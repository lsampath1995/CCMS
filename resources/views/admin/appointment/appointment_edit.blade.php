    ...
    <div class="page-title">
        ...
        <div class="title_right">
            <div class="form-group pull-right top_search">
                <a href="{{ route('appointment.index') }}" class="btn btn-primary"><i class="fa fa-backward"></i>&nbsp;&nbsp;Back</a>
            </div>
        </div>
    </div><br><br><br>
    <div class="row">
                    ...
                    <form id="add_appointment" name="add_appointment" role="form" method="POST"
                        ...
                        <div class="row">
                            <div class="x_content">
                                ...
                                <div class="row"><br>
                                    <div class="col-md-12 form-group">
                                        <label for="note">Appointment Note(s) and Document URL(s)</label>
                                        <textarea type="text"
                                                  placeholder="enter appointment note(s) and document url(s)"
