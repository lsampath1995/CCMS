        ...
        <form action="{{route('role.update',$role->id)}}" method="POST" id="roleForm" name="roleForm">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2"><i class="fa fa-user"></i>&nbsp;&nbsp;Edit Role</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            ...
                            <input type="text" placeholder="enter role name" class="form-control" id="slug" name="slug"
                                   value="{{ $role->slug ?? '' }}">
                        </div>
