<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="Casetransfermodal">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">Case Transfers</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        <label for="fullname">Transfer Date <span class="text-danger">*</span></label>
                        <input type="text" placeholder="" class="form-control">
                    </div>
                </div>
