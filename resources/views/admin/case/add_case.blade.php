                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 col-sm-12 col-xs-12 form-group"><br>
                                <label for="fullname">Case Document Title(s) and URL(s)<span class="text-danger"></span></label>
                                <textarea id="description" placeholder="enter case document title(s) and url(s)"
