<div class="modal-header">
    ...
    <h4 class="modal-title"><i class="fa fa-calendar"></i>&nbsp;&nbsp;Add Next Date</h4>
</div>
<form id="add_next_date" name="add_next_date" role="form" method="POST">
    {{ csrf_field() }}
    <input type="hidden" id="case_id" name="case_id" value="{{$case->id}}">
    <input type="hidden" id="business_on_date" name="business_on_date" value="{{$case->next_date}}">
    <div class="modal-body">
                        ...
                        <select class="form-control select2" id="case_status" name="case_status" style="width:100%;">
                            ...
                            @foreach($caseStatuses as $caseStatus)
                                ...
                                <option value="{{$caseStatus->id}}"
                                        myvalue="{{$caseStatus->case_status_name}}" {{(!empty($case) && $case->case_status==$caseStatus->id && $case->is_active=='Yes')?'selected':''}}>{{$caseStatus->case_status_name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
        ...
        <div class="row" id="show_nextDate_div">
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group">
                        <label class="discount_text"> Next Hearing Date <span class="text-danger">*</span></label>
                        <input type="text" class="form-control case_next_date"
                               placeholder="enter next case hearing date" id="next_date" name="next_date" readonly="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="contct-info">
                        <div class="form-group">
                            ...
                            <input type="text" id="decision_date" name="decision_date"
                                   class="form-control datetimepickerdecisiondate" readonly="" value="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="contct-info">
                        <div class="form-group">
                            ...
                            <input type="text" id="nature_disposal" name="nature_disposal" class="form-control"
                                   value="">
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group"><br>
                        ...
                        <textarea placeholder="add remarks" class="form-control" id="remarks" name="remarks"></textarea>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" name="case_next_date_btn" class="btn btn-success waves-effect waves-light">
            <i class="fa fa-save"></i>&nbsp;&nbsp;Save&nbsp;&nbsp;<i class="fa fa-spinner fa-spin hide"
                                                                     id="btn_loader"></i></button>
    </div>
</form>
