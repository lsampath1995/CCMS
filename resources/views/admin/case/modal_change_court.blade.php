...
<form id="case_transfer" name="case_transfer" role="form" method="POST" action="{{ url('admin/transferCaseCourt')}}">
    ...
    <div class="modal-body">
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group">
                        ...
                        <input type="text" id="court_number" name="court_number"
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group"><br>
                        <label class="discount_text"> Judge Name <span class="text-danger">*</span></label>
                        <select class="form-control select2 selct2-width-100" id="judge_type" name="judge_type">
                            <option value="">elect judge name</option>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="contct-info">
                    <div class="form-group"><br>
                        <label class="discount_text"> Judge Type</label>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" name="case_transfer_btn" class="btn btn-success waves-effect waves-light"><i
                class="fa fa-save"></i>&nbsp;&nbsp;Save&nbsp;&nbsp;<i
