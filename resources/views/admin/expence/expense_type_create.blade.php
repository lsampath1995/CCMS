<div class="modal fade" id="addtag" role="dialog" aria-labelledby="addcategory" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="{{ route('expense-type.store') }}" method="POST" id="tagForm" name="tagForm">
            @csrf()
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2"><i class="fa fa-money"></i>&nbsp;&nbsp;Add Expense Type
                    </h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="case_subtype">Expense Type <span class="text-danger">*</span></label>
                            <input type="text" placeholder="enter expense type" class="form-control" id="name"
                                   name="name">
                        </div>
                    </div>
                    <div class="row">
