    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-money"></i>&nbsp;&nbsp;Payment Made History</h4>
            </div>
                        ...
                        <table class="table">
                            ...
                            @forelse($getPaymentHistory as $history)
                                <tr>
                                    ...
                                    <td>
                                        Rs.&nbsp;{!! App\Helpers\LogActivity::moneyFormatIndia(round($history->amount)) !!}</td>
                                    ...
                                    <td>{{$history->payment_type}} @if($history->payment_type=='Cheque')
                                            ({{date(LogActivity::commonDateFromatType(),strtotime($history->cheque_date))}}
                                            ) @endif</td>
