        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="form-group pull-right top_search">
                    <a href="{{ url('admin/expense') }}" class="btn btn-primary"><i class="fa fa-backward"></i>&nbsp;&nbsp;Back</a>
                </div>
            </div>
        </div>
        <br><br><br>
                ...
                <section class="content invoice">
                    <div class="row"><br>
                        <div class="col-xs-12 invoice-header" align="center">
                            <h1><b>{{ $expense->invoice_no}} - Expense</b></h1>
                        </div>
                        @if (count($errors) > 0)
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    <label for="vendor">Vendor Company Name <span class="text-danger">*</span></label>
                                    ...
                                    <label for="billed_from">Billed From : <span
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 text-center">
                                    <a href="{{ url('admin/expense') }}" class="btn btn-danger"><i
