<div class="modal fade" id="addtag" role="dialog" aria-labelledby="addcategory" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="{{ route('service.store') }}" method="POST" id="tagForm" name="tagForm">
            @csrf()
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group"><br>
                            <label for="case_subtype">Service Charge (LKR)<span class="text-danger">*</span></label>
                            <input type="text" placeholder="enter service charge" class="form-control" id="amount"
                                   name="amount">
                        </div>
                    </div>
                </div>
