...
@section('content')
    ...
    <div class="title_right">
        <div class="form-group pull-right top_search">
            <a href="{{url('admin/tasks')}}" class="btn btn-primary"><i class="fa fa-backward"></i>
                &nbsp;&nbsp;Back</a>
        </div>
    </div><br><br><br>
    <div class="row">
                    ...
                    <div class="x_content">
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">Task Subject <span class="text-danger">*</span></label>
                                <input type="text" placeholder="enter task subject" class="form-control"
                                       id="task_subject"
                                       name="task_subject">
                            </div>
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">Task Start Date <span class="text-danger">*</span></label>
                                <input type="text" placeholder="enter task start date" class="form-control dateFrom"
                                       id="start_date"
                                       name="start_date" readonly="">
                            </div>
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname">Task Deadline <span class="text-danger">*</span></label>
                                <input type="text" placeholder="enter task end date" class="form-control dateTo"
                                       id="end_date"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group"><br>
                                <label for="fullname">Task Priority <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group"><br>
                                <label for="fullname">Task Assign To <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group"><br>
                                <label for="fullname">Task Related To</label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group task_selection hide"><br>
                                <label for="fullname">Select Case</label>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group"><br>
                                <label for="fullname">Task Description & Document URL Link(s)</label>
                        ...
                        <div class="form-group pull-right">
                            <div class="col-md-12 col-sm-6 col-xs-12">
                                <a class="btn btn-danger" href="{{ route('tasks.index') }}"><i class="fa fa-times"></i>&nbsp;&nbsp;Cancel</a>
