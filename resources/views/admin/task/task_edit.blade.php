                    ...
                    <div class="x_content">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="text" placeholder="enter task start date" readonly=""
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="text" placeholder="enter task end date" readonly=""
                                       class="form-control dateTo" id="end_date"
                                       name="end_date"
                        ...
                        <div class="row">
                            ...
                            @endphp
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group task_selection {{ $style }}"><br>
