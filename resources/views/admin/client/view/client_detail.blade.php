...
@section('content')
    <div class="page-title">
        <div class="title_left">
            <h4><i class="fa fa-user"></i> Client Name : {{$name}} </h4>
        </div>
    </div>
    <div class="title_right">
        <div class="form-group pull-right top_search">
            <a href="{{url('admin/clients')}}" class="btn btn-primary"><i class="fa fa-backward"></i>
                &nbsp;&nbsp;Back</a>
        </div>
    </div><br><br><br>
    <div class="row">
                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="{{ request()->is('admin/clients/*') ? 'active' : '' }}"><a
                                href="{{ route('clients.show', [$client->id]) }}">Client Details</a>
                        </li>
                        ...
                        @if($adminHasPermition->can(['invoice_list']) =="1")
                            <li class="{{ request()->is('admin/client/account-list/*') ? 'active' : '' }}"
                                role="presentation"><a
                                    href="{{route('clients.account-list',[$client->id])}}">Payments</a>
                            </li>
                        @endif
                    </ul>
                </div>
                    ...
                    <div class="x_content">
                        <div class="dashboard-widget-content">
                            ...
                            @if(isset($single) && !empty($single))
                                @foreach($single as $s)
                                    <div class="col-md-6 hidden-small">
                                        <h4 class="line_30"><i class="fa fa-user"></i> Other Parties Details</h4><br>
                                        <table class="countries_list">
                                            <tbody>
                                            <tr>
                                            ...
                                            @if($client->client_type=="multiple")
                                                <tr>
                                                    <td>Advocate Name : {{ $s->party_advocate}}</td>
                                                </tr>
                                            @endif
                                            </tbody>
                                        </table>
